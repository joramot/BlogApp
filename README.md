...
**Blog App** is a website made with RoR that can display your blogs along with their likes and comments.
...
- **You can blog using this website**
...
```sh
  cd my-folder
  git clone https://github.com/joramot/BlogApp.git
```
